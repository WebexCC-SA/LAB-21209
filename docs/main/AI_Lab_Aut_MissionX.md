...
3. Name the new flow **<copy>AutonomousAI_Flow_21209_<w class="attendee"></w></copy>** and click on **Create Flow**.
...
8. Assign the Flow to your **Channel (Entry Point)**. Do this by first going to **Channels** and search for your channel **<copy><w class="attendee"></w>\_21209_Channel</copy>**.
   ![Profiles](../graphics/Lab1_AI_Agent/2.52.png)

9. Click on **<copy><w class="attendee"></w>\_21209_Channel</copy>**. In the **Channel** settings section, change the following and then **Save** the changes.<br/>
...
1. Go to **Control Hub** and from **Overview > Quick Links**, select **Desktop** option. Select **Desktop** endpoint option and choose the team **<copy><w class="attendee"></w>\_21209_Team</copy>**. Click **Save and Continue**. Allow browser to access Microphone by clicking **Allow** on every visit.
...
3. Dial the support number assigned to your **<w class="attendee"></w>\_21209_Channel** channel, and during the conversation with the AI agent, ask to **talk to a healthcare professional or live agent**.
